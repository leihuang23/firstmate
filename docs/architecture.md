...
That keeps spawn launch compatible across claude, codex, opencode, pi, pi-signed, grok, kimi, omp, and muse while preserving the requested profile for later audit.
