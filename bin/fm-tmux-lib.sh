...
# kimi: thinking... / moon-phase / Running a command (verified kimi-code 0.26.0).
FM_TMUX_BUSY_REGEX_DEFAULT='esc (to )?interrupt|Working\.\.\.|Ctrl\+c:cancel|thinking\.\.\.|Running a command|[🌑🌒🌓🌔🌕🌖🌗🌘]'
