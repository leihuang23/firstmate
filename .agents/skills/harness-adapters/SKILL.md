...
It starts the successor arm before that delivery, and a rejected follow-up leaves the successor running while recording `state/omp-watch-delivery.status` for watcher and session-start surfacing.
